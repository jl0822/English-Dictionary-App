...
class MainActivity : AppCompatActivity() {
    ...
    fun findWord(view: View){
        ...
        var myAsyncTask = MyAsynchTas()

        myAsyncTask.execute(stringUrl)
    }

    inner class MyAsynchTas : AsyncTask<String, Void, Data>(){
    ...
    fun makeHttpResponse(url : URL?): String{
        ...
        try {
            ...
            urlConnection.setRequestProperty("app_id", "9297d925")
            urlConnection.setRequestProperty("app_key", "23cf5984c155ee8f27f833064eb98652")
